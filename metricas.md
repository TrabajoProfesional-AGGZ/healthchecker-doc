...
* **Actividad de commits:** ![Commits](https://img.shields.io/badge/Commits_Totales-30-blue)
* **Pull Requests cerrados:** ![PRs](https://img.shields.io/badge/PRs_Cerrados-8-purple)
...
| :--- | :---: | :---: | :---: |
| **Ascencio, Felipe Santino** (`FelipeAscencio`) | 15 | 737 | 102 |
| **Ghosn, Lautaro Gabriel** (`LGhosn`) | 12 | 576 | 147 |
